...
#define NUM_LEDS    100 //change to match your setup, for multiple runs of LEDs use the number of the run with the most LEDs.
...
#define colorstatuspub "bruh/mqttstrip2/colorstatus"
#define setcolorsub "bruh/mqttstrip2/setcolor"
#define setpowersub "bruh/mqttstrip2/setpower"
#define seteffectsub "bruh/mqttstrip2/seteffect"
#define seteffectsub2 "bruh/mqttstrip2/seteffect2"
#define setbrightness "bruh/mqttstrip2/setbrightness"

#define setcolorpub "bruh/mqttstrip2/setcolorpub"
#define setpowerpub "bruh/mqttstrip2/setpowerpub"
#define seteffectpub "bruh/mqttstrip2/seteffectpub"
#define seteffectpub2 "bruh/mqttstrip2/seteffectpub2"
#define setbrightnesspub "bruh/mqttstrip2/setbrightnesspub"
#define setanimationspeed "bruh/mqttstrip2/setanimationspeed"
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    // Attempt to connect
  if (client.connect("PorchLEDsChanged", mqtt_user, mqtt_password)) {
